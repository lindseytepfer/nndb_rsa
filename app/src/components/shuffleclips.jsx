...
export const ShuffleClips = ({ setSequence, setDurations, pageEvent }) => {
  ...
  const videoclips = {
    ...
    citizenfour: {
      0: "citizenfour_1797_1820",
      1: "citizenfour_1820_1844",
    ...
    theshawshankredemption: {
      0: "theshawshankredemption_613_635",
  ...
  const clipLengths = {
    ...
    "theshawshankredemption_613_635": 22020,
  ...
  const handleDurations = () => {
    selection.map((selection) => {
      length.push(clipLengths[selection]);
    });
  };
  ...
  return (
    <div className="container">
      <h1>
        ...
        <br /> and grab headphones if you need them!{" "}
      </h1>
      <p>When you are ready, press "start" to play the first video:</p>
      <button className="advance-button" onClick={startTask}>
        start
      </button>
    </div>
  );
